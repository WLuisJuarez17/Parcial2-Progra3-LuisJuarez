...
public class ClientControl {
	...
	public Cliente updateCliente(@PathVariable(name = "id")Long id, 
		...
		if(oCliente.isPresent()) {
			...
			actual.setId(id);
			actual.setName(cliente.getName());
			actual.setAge(cliente.getAge());
			actual.setSex(cliente.getSex());
			actual.setCountry(cliente.getCountry());	
			actual.setcDate(cliente.getcDate());
			Cliente updatedClient = repository.save(actual);
